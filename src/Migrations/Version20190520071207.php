...
final class Version20190520071207 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE overzicht_kok (id INT AUTO_INCREMENT NOT NULL, menu_itemcode_id INT NOT NULL, tafel VARCHAR(3) NOT NULL, datum VARCHAR(255) NOT NULL, tijd VARCHAR(255) NOT NULL, aantal INT NOT NULL, prijs NUMERIC(5, 2) NOT NULL, INDEX IDX_3114F830EC7217 (menu_itemcode_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE overzicht_kok ADD CONSTRAINT FK_3114F830EC7217 FOREIGN KEY (menu_itemcode_id) REFERENCES menu_item (id)');
        $this->addSql('ALTER TABLE subgerecht ADD CONSTRAINT FK_FF110E5E8D4232BE FOREIGN KEY (gerechtcode_id) REFERENCES gerecht (id)');
        $this->addSql('ALTER TABLE bon ADD CONSTRAINT FK_FC7DFD6B77647B1 FOREIGN KEY (tafel_id) REFERENCES overzicht_kok (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE overzicht_kok DROP FOREIGN KEY FK_3114F830EC7217');
        ...
        $this->addSql('DROP TABLE overzicht_kok');
